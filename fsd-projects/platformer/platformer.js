$(function () {
  ...
  function setup() {
    ...
    createCollectable("database", 650, 475, 0.5, 1)
    createCollectable("database", 1050, 350, 0.5, 1)
    createCollectable("database", 1350, 350, 0.5, 1)
    createCollectable("database", 1100, 600, 0.5, 1)
